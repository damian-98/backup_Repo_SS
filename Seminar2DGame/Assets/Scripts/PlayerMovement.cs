...
// ####################################################################################################################################################
    ...
    private Rigidbody2D rb;// This variable will be used to refrence unity RigidBody2D function
    ...
    private float inputVertical; // This inputVertical variable will be used to detect weather player is holding down up or down keys
...
// #5: ####################################################################################################################################################
    void FixedUpdate(){// The FixedUpdate method is used to  manipulate all physics aspects of the game
        ...
        if(isClimbing == true && hitInfo.collider != null){//This block of code is saying if climbing is true and the ray
